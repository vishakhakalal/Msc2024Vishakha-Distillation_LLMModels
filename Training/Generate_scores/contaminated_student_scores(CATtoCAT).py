...
# Define paths
model_path = "/nfs/primary/distillation/Training/outputStudent(poison_10k_CATMODEL)"
...
output_json_path = "poison_student_scores_10k_CAT.json"
...
student_model = CatTransformer.from_pretrained(model_path, batch_size=512, text_field='text', device=device)
