...
def run_topics():
    # Hard-coded paths
    topics_or_res_path = '/nfs/primary/distillation/eval/bm25_results_DL20_cross.trec'
    ir_dataset_name = 'msmarco-passage/trec-dl-2020/judged'
    model_dir = '/nfs/primary/distillation/Training/outputTeacher(normal_10k)'  # Path to saved model and tokenizer
    out_path = '/nfs/primary/distillation/eval/Teacher/teacher_eval_DL2020/teacher_normal_DL2020.trec'
